...
Future work can explore more tight-knit collaborative scenarios where multiple pick-and-place tasks can be composed to communicate more complex challenges. The study of the \textit{commonsense} settings opens up intriguing avenues of how such composite tasks like \textit{`setting up a dining table'} may be defined. The rules explored in the current work can serve to narrow down the domain of possible problem specifications in robotics challenges that involve human environments. 

While the current work studies the modalities of pointing and verbal cues, effects of including additional robotic communication in the form of heads-up displays or simulated eye-gaze would be a very fascinating direction to explore.
